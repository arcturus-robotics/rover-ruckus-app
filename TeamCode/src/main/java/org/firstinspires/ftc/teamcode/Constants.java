...
public class Constants {
    ...
    /**
     * The amount of degrees it takes for the latch to lower the robot to the ground or raise it to the landerkl
     */
    public static final double LATCH_ANGLE = Utilities.revolutionsToDegrees(16);
